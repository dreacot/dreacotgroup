                        ...
                        <div class="pricing-table">
                            ...
                            <div class="pricing-table-content">
                                ...
                                <div class="pricing-table-button">
                                        <button type="button" class="btn btn-primary-filled" onclick="payWithPaystack()"><strong>BUY
                                                SERVICE</strong></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="featured pricing-table">
                            ...
                            <div class="pricing-table-content">
                                ...
                                <div class="pricing-table-button">
                                        <button type="button" class="btn btn-primary-filled" onclick="payWithPaystack2()"><strong>BUY
                                                SERVICE</strong></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pricing-table">
                                ...
                                <div class="pricing-table-content">
                                    ...
                                    <div class="pricing-table-button">
                                        ...
                                        <button type="button" class="btn btn-primary-filled" onclick="payWithPaystack3()"><strong>BUY
                                                SERVICE</strong></button>
                                    </div>
                                </div>
                            </div>
